...
<head>
  ...
  <title>Modulo Subir Archivo</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row justify-content-center">
          <form action="views/recibirArchivo.php" method="POST" enctype="multipart/form-data">
            <div class="form-group">
              <label for="subirArchivo" class="form-label">Subir archivo CSV o TXT</label>
